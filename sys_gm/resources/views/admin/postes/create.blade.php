...
@section('content')
    <div class="">
        @if(isset($structure))
            ...
            <form class="space-y-8 mt-4" action="{{ route($poste->exists ? 'admin.postes.update':'admin.postes.store', $poste) }}" method="post">
                @csrf
                ...
                <div class="flex justify-end gap-4">
                    <a href="{{ route('admin.structures.edit', $structure) }}" type="button"
                    ...
                    @forelse ($structures as $structure)
                        <tr class="border-b transition-colors hover:bg-muted/50">
                            ...
                            <td class="p-2 align-middle flex justify-end gap-2">
                                <a href="{{ route('admin.postes.create', ['structure' => $structure->id]) }}"
