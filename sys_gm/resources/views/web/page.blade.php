            ...
            <div class="flex">
                @if (Route::has('login'))
                    @auth
                        <a
                            href="{{ url('/dashboard') }}"
                            class="mr-10 hidden rounded-md bg-blue-500 px-8 py-2.5 font-semibold text-white shadow-md shadow-blue-500/20 duration-200 hover:bg-blue-600 sm:block lg:mr-0"
                        >
                            Dashboard
                        </a>
                    @else
...
<section class="relative bg-gray-700 py-16 lg:pt-[100px]">
...
<section class="relative overflow-hidden py-16 bg-gray-700">
