...
@section('content')
    ...
    <div class="">
        <div class="fade-in">
            <div class="mb-6">
                <a class="inline-flex items-center text-gray-600 hover:text-gray-800 mb-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 mb-2">
                            Demande #{{ $demande->code_dossier }}
                        </h1>
                        <div class="flex items-center">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 mr-2">
                                {{ $demande->statut }}
                            </span>
                            <span class="text-gray-600">{{ $demande->created_at->format('d/m/Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-base text-gray-800">{{ $demande->typemobilite->intitule_mobilite }}</p>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">
                                        Agent concerné
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-base text-gray-800">
                                        {{ $demande->structure->nom_structure }}
                                    </p>
                                </div>
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500">
                            ...
                            <div class="mt-6">
                                ...
                                <p class="mt-1 text-base text-gray-800">
                                    {{ $demande->motif }} @if ($demande->motif == null) Aucun @endif
                                </p>
                            </div>
                            <div class="mt-6">
                                ...
                                <div class="space-y-2">
                                    @if ($demande->piecesJustificatives->isNotEmpty())
                                        @foreach ($demande->piecesJustificatives as $document)
                                            <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-800">{{ $demande->agent->matricule }}</p>
                                </div>
                                <div>
                                    <h4
                                        class="text-xs font-medium text-gray-500 uppercase"
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-800">
                                        {{ $demande->agent->structure->nom_structure }}
                                    </p>
                                </div>
                            </div>
                            <div class="mt-6">
