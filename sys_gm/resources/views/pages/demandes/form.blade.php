            ...
            <div class="card">
                ...
                <form class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label for="agentId" class="block text-sm font-medium text-gray-700 mb-1" >Matricule de l'agent*</label>
                            <input type="text" id="agentId" name="agentId" class="input-field" placeholder="Exemple: 12345A" value=""/>
                        </div>
                        <div>
                            <label for="agentName" class="block text-sm font-medium text-gray-700 mb-1" >Nom complet de l'agent*</label>
                            <input type="text" id="agentName" name="agentName" class="input-field" placeholder="Prénom et NOM" value=""/>
                        </div>
                        <div>
                            <label for="mobilityType" class="block text-sm font-medium text-gray-700 mb-1" >Type de mobilité*</label
                            >
                            <select id="mobilityType" name="mobilityType" class="input-field">
                                <option value="">
                        ...
                        <div>
                            <label for="startDate" class="block text-sm font-medium text-gray-700 mb-1" >Date souhaitée*</label>
                            <input type="date" id="startDate" name="startDate" class="input-field" value=""/>
                        </div>
                        <div>
                            <label for="currentDepartment" class="block text-sm font-medium text-gray-700 mb-1" >Structure actuelle*</label>
                            <select id="currentDepartment" name="currentDepartment" class="input-field">
