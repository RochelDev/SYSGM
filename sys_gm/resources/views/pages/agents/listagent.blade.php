<div class="fade-in">
    <div class="mb-6">
        ...
        <p class="text-gray-600">
            Consultez les informations des agents de l'administration publique.
        </p>
    </div>
    <div class="card mb-6">
